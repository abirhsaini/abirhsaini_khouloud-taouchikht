...
const Dinner = () => {
    ...
    return (
        ...
        <
        /div> <
        div className = 'col' > < a className = "photo1" > < img className = "photo"
        src = { img1 }
        alt = "baked eggs " / > < /a></div >

        <
        button type = "button"
        onClick = { faireredirection }
        class = "btn btn-warning" > buy now!! < /button>
        ...
        div className = 'col' >
        <
        a className = "photo2" > < img className = 'photo'
        src = { img2 }
        alt = 'granola' / > < /a> <
        /div> <
        button type = "button"
        class = "btn btn-warning"
        onClick = { faireredirection } > buy now!! < /button>
        ...
        div className = "col" >
        <
        a className = "photo3" > < img className = "photo"
        src = { img3 }
        alt = "raspberry-oatmeal-breakfast-bars " / > < /a>
